...
: wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(WIDTH, HEIGHT))
{
	...
	/* Slider panel */
	SliderPanel *sp = new SliderPanel(this);
...
SliderPanel::SliderPanel(wxFrame *parent)
: wxPanel(parent, wxID_ANY)
{
	...
	/* Connect */
	Connect(ID_SLIDER, wxEVT_COMMAND_SLIDER_UPDATED, wxScrollEventHandler(SliderPanel::OnScroll));
	Connect(wxEVT_PAINT, wxPaintEventHandler(SliderPanel::OnPaint));

}

/* Slider scroll */
void SliderPanel::OnScroll(wxScrollEvent &event)
{
...
/* Slider paint */
void SliderPanel::OnPaint(wxPaintEvent &event)
{
